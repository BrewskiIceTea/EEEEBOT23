...
byte speedSetting = 120;   //initial speed = 0
...
void changeSteeringAngle(float angle){ // 83 middle 53 left 113
  constrain(angle, 61, 105);
  steeringAngle = (angle * 2.33) + 240;
